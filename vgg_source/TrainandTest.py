...
def model_fn(model_dir):
    ...
    model.fc = torch.nn.Sequential(nn.Linear(25088, 1024),
                             nn.ReLU(),
                             nn.Dropout(0.2),
                             nn.Linear(1024, 512), 
                             nn.ReLU(),
...
if __name__ == '__main__':
    ...
    #Using ResNeXt-101 32x8d model
    print('Downloading the ResNeXt-101 32x8d model')
    model = torchvision.models.vgg16()
    
    #Changing the Fully Connected Layer to train on our data
    print("Replacing the model's Fully Connected Layer")
    model.classifier = torch.nn.Sequential(nn.Linear(25088, 1024),
                                           nn.ReLU(),
                                           nn.Dropout(0.2),
                                           nn.Linear(1024, 512), 
                                           nn.ReLU(),
